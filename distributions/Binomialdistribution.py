...
class Binomial(Distribution):
    ...
    def plot_bar(self):
        ...
        plt.title('Bar Chart Data')
        plt.xlabel('headsortails')
        plt.ylabel('results')
    ...
    def pdf(self, k):
        ...
        """
        prob = math.factorial(self.n) / (math.factorial(k) * math.factorial(self.n - k)) * self.p**k * (1-self.p)**(self.n-k)
        return prob
